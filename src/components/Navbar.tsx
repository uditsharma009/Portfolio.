      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <button
            ...
            className="lg:hidden relative w-10 h-10 flex items-center justify-center text-cream focus:outline-none"
          ...
          >
            <div className="w-6 flex flex-col items-end gap-1.5">
              <motion.span
                ...
                className="block h-0.5 bg-cream rounded-full origin-center"
                style={{ width: 24 }}
              />
              <motion.span
                animate={
                ...
                className="block h-0.5 w-5 bg-cream rounded-full"
              />
              <motion.span
                animate={
                  isMobileMenuOpen
                  ...
                  <motion.a
                    ...
                    className={`block px-4 py-2.5 rounded-xl text-sm font-medium transition-colors duration-200 ${
                      isActive
                        ...
                        : 'text-cream hover:text-copper hover:bg-copper/5'
                    }`}
                  >
                    {link.label}
                  </motion.a>
